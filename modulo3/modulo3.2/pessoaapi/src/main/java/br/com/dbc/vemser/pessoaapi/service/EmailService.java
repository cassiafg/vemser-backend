...
//        helper.addAttachment(file1.getName(), file);
    ...
    public void sendEmailExcluirPessoa(PessoaEntity pessoa){
        SimpleMailMessage message = new SimpleMailMessage();
        message.setFrom(from);
    ...
    public void sendEmailCriarEndereco(PessoaEntity pessoa){
    ...
    public String getContentFromTemplateCriarEndereco(PessoaEntity pessoa) throws IOException, TemplateException {
    ...
    public void sendEmailAlterarEndereco(PessoaEntity pessoa){
        MimeMessage mimeMessage = emailSender.createMimeMessage();
        try {
            MimeMessageHelper mimeMessageHelper = new MimeMessageHelper(mimeMessage, true);
    ...
    public String getContentFromTemplateAlterarEndereco(PessoaEntity pessoa) throws IOException, TemplateException {
        Map<String, Object> dados = new HashMap<>();
        dados.put("nome", pessoa.getNome());
    ...
    public void sendEmailDeletarEndereco(PessoaEntity pessoa){
        MimeMessage mimeMessage = emailSender.createMimeMessage();
        try {
            MimeMessageHelper mimeMessageHelper = new MimeMessageHelper(mimeMessage, true);
    ...
    public String getContentFromTemplateDeletarEndereco(PessoaEntity pessoa) throws IOException, TemplateException {
        Map<String, Object> dados = new HashMap<>();
        dados.put("nome", pessoa.getNome());
